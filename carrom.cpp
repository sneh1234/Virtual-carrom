...
void handle_angle(int x, int y)
{
    ...
    //s.angle=atan(((y-s.y)/(x-s.x)))*180/3.14;
    //s.y=y;
}
...
strcpy(string,"Player 1: ");
      ...
      t2=score2-time1;//+t1-t2;
       glColor3f(1.0,1.0,1.0);
        ...
        //if(t2<0)
       //{
        //glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'S') ,glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'c'),     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'o'),     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'r'),     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'e'),   glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,' '),glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'1') ,glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,':'),  glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,' ');     
        for(int j=0;j<10;j++)
       ...
       for(int j=0;j<10;j++)
        //glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'S') ,glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'c'),     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'o'),     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'r'),     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'e'),   glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,' '),glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,'2') ,glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,':'),  glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,' ');     
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,string[j]);
        //glColor3f(1.0,1.0,1.0);
        //glRasterPos3f(-4.4,2.1,0);
...
count+=s.applyfriction();
      s.x+=s.vel_x;
    s.y+=s.vel_y;
  // energy+=2*(s.vel_x*s.vel_x+s.vel_y*s.vel_y);
if(count==20)
  {
    //s.y=-1.73;
    if(!newchance)
    ...
    //if(!queen_inside )
      //  coins[0].x=0,coins[0].y=0,queen_inside=-3;
    if(max_chance==0)
...
glEnd();
   ...
   // glColor3v(1.0f,0.0f,0.0f);
    ...
    glBegin(GL_QUADS);
    //glColor3f(0.925f,0.788f,0.569f);
glColor3f(0.99,0.96,0.558);
    glVertex2f(-len / 2, -len / 2);
    glVertex2f(len / 2, -len / 2);
    glVertex2f(len / 2, len / 2);
...
glEnd();
    ...
    for(int i=0;i<92;i++)
    {  glBegin(GL_LINES);
   //  glColor3f(0.406f, 0.152f, 0.042f);
    glColor3f(0.625f,0.32f,0.074f);
